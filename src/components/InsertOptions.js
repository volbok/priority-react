...
function InsertOptions() {
  ...
  const viewInsertOptions = useSelector(state => state.inserirOptions);
  ...
  if (viewInsertOptions == 1 && dc == 0) {
    ...
    // eslint-disable-next-line
  } else if (viewInsertOptions == 1 && dc == 1) {
    return (
      <div
        style={{
          display: 'flex',
